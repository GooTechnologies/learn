...
This piece of code creates our first **[Entity](http://code.gooengine.com/latest/docs/Entity.html) **by calling **createEntity** on the [**world**](http://code.gooengine.com/latest/docs/World.html) object. As we read above in an **ECS** an entity is very **simple**. In Goo it only contains an **ID**, a **name** and a **collection** of assigned **components.** **createEntity** hides all of the boilerplate code that is needed to be able to render an entity. The minimum components needed to render an entity are: [**TransformComponent**](http://code.gooengine.com/latest/docs/TransformComponent.html), [**MeshDataComponent**](http://code.gooengine.com/latest/docs/MeshDataComponent.html) and [**MeshRendererComponent**](http://code.gooengine.com/latest/docs/MeshRendererComponent.html). So the way we call it world.createEntity basically does this for us:
...
The [**TransformComponent**](http://code.gooengine.com/latest/docs/TransformComponent.html) contains the information where an entity is located (**translation**), if and how it is re-sized (**scale**) and where it is looking at (**rotation**). Together these three properties form what is called a **transform** in the math world. You can access these properties like this:
