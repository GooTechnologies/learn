...
short_description: In this tutorial we will make the first part of a pinball game.
thumbnail: tutorials/create/physics-part-1/thumbnail.jpg
scene: 05779f4996204f14aabff73ee0333afe.scene
duration: 20 minutes
---
In this tutorial we will make a pinball game. Use the arrow or WSAD keys to play.

The tutorial is split in two parts.

 * Part 1: create a tilted box, a few cylinders and a ball
 * Part 2: enhance the scene to become a simple pinball game

<center>
    <p>
        <img src="goo-pinball.gif" alt="Pinball game" />
        <a class="hidewhenincreate btn btn-primary btn-lg" target="_blank" href="https://c1.goote.ch/05779f4996204f14aabff73ee0333afe.scene">Launch finished game</a>
        <a class="hidewhenincreate btn btn-default btn-lg" href="https://app.goocreate.com/edit/05779f4996204f14aabff73ee0333afe.scene">Open scene in Create</a>
    </p>
</center>
